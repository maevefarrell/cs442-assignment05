...
public class NamesResource {
	...
	public static String getRandomID() 
	{
		String id = "";
		long L = 0;
		while(L < 10000000) L = Math.abs(ranGen.nextLong())%1000000000;
		if (L < 100000000)
			id = "0" + L;
		else
			id = "" + L;
...
//			{
//				LocalDate d = getRandomBirthDate(1998, 2004);
//				int k = ranGen.nextInt(binghamtonMajors.length);
//				double x = 260 + 140*ranGen.nextDouble();
//				x = Math.round(x)/100.0;
//				ps.println(getRandomLastName() + ", " + getRandomFirstName() + ", " + 
//						d.getYear() + ", " + d.getMonthValue() + ", " + d.getDayOfMonth()
//						+ ", " + binghamtonMajors[k]  + ", " + x);
//				Person p = new Person(getRandomLastName(), 
//						getRandomFirstName(), getRandomID(), d);
//				System.out.println(p);
//				System.out.println(
//						new Student(p, binghamtonMajors[k]));
//			}
//		}
//	}
